app.controller('LoginController', function($scope, $rootScope, $state, AuthService, CONSTANTS, $firebaseObject){
...
//         $rootScope.member = $firebaseObject(new Firebase(CONSTANTS.fbRef + 'questions/' + id));
//         cb ? cb() : '';
//     }
